...
#SBATCH --job-name="Landspill Inclined Plane Validation"
#SBATCH --nodes=1
...
ROOT_DIR=/lustre/groups/barbalab/pychuang/geoclaw-landspill-paper/repro-pack/runs
CASE_NAME=silicone-oil-inclined-plane
